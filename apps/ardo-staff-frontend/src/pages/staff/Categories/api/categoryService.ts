...
export class CategoryService {
    ...
    static async uploadCategoryImage(request: FormData): Promise<AxiosResponse<SuccessResponse<ImageUploadResponse> | ErrorResponse>> {
        return $apiFormData.post<SuccessResponse<ImageUploadResponse> | ErrorResponse>(ApiRoutes.POST_UPLOAD_CATEGORY_IMAGE, request);
    }
}
